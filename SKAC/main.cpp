...
int main(){
    ...
    cout<<"Input , memory, bucket_num, sketch_depth, alpha, beta"<<endl;
    cout<<"for example: 40  20 3 1.0 1.0"<<endl;
    cin>>skp_mem>>skp_bkt_num>>skp_col_num>>skp_a>>skp_b;
   ...
   // int ab_error=0, re_error=0;
    ...
    outFile <<filename<<",skpower,"<<skp_mem/(8*1024)<<","<<skp_bkt_num<<","<<skp_col_num<<","<<skp_a<<","<<skp_b<<","<<
